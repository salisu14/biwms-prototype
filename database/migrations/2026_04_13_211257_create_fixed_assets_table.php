...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('fixed_assets', function (Blueprint $table) {
            ...
            // Depreciation setup
            $table->enum('depreciation_method', \App\Enums\DepreciationMethod::cases())->default('straight_line');
            ...
            $table->enum('declining_balance_calc', \App\Enums\DepreciationCalculationMethod::cases())->nullable();
            ...
            // Status
            $table->enum('status', \App\Enums\FAStatus::cases())->default('new');
