    ...
    public function run(): void
    {
        ...
        $matrix = [
            ...
            'factory-operator' => [
                ...
                'factory.production_bom_version.view_any', 'factory.production_bom_version.view',
                'factory.routing.view_any', 'factory.routing.view',
                'factory.routing_version.view_any', 'factory.routing_version.view',
                'factory.machine_center.view_any', 'factory.machine_center.view',
                'factory.work_center.view_any', 'factory.work_center.view',
                'factory.work_center_group.view_any', 'factory.work_center_group.view',
                'factory.overhead_cost_category.view_any', 'factory.overhead_cost_category.view',
                'factory.actual_overhead_cost.view_any', 'factory.actual_overhead_cost.view',
                'sales.item.view_any', 'sales.item.view',
            ],
            'factory-manager' => [
