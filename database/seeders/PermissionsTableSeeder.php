...
class PermissionsTableSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $bcPermissions = [
            ...
            'sales.referral_commission_setting.view_any', 'sales.referral_commission_setting.view', 'sales.referral_commission_setting.create', 'sales.referral_commission_setting.update', 'sales.referral_commission_setting.delete', 'sales.referral_commission_setting.delete_any', 'sales.referral_commission_setting.restore', 'sales.referral_commission_setting.restore_any', 'sales.referral_commission_setting.force_delete', 'sales.referral_commission_setting.force_delete_any', 'sales.referral_commission_setting.manage',
            'sales.referral_commission_plan.view_any', 'sales.referral_commission_plan.view', 'sales.referral_commission_plan.create', 'sales.referral_commission_plan.update', 'sales.referral_commission_plan.delete', 'sales.referral_commission_plan.delete_any', 'sales.referral_commission_plan.restore', 'sales.referral_commission_plan.restore_any', 'sales.referral_commission_plan.force_delete', 'sales.referral_commission_plan.force_delete_any',
            'sales.referral_commission_plan.activate', 'sales.referral_commission_plan.inactivate', 'sales.referral_commission_plan.archive',
            'sales.referrer_commission_plan_assignment.view_any', 'sales.referrer_commission_plan_assignment.view', 'sales.referrer_commission_plan_assignment.create', 'sales.referrer_commission_plan_assignment.update', 'sales.referrer_commission_plan_assignment.delete', 'sales.referrer_commission_plan_assignment.delete_any', 'sales.referrer_commission_plan_assignment.restore', 'sales.referrer_commission_plan_assignment.restore_any', 'sales.referrer_commission_plan_assignment.force_delete', 'sales.referrer_commission_plan_assignment.force_delete_any',
            'sales.referrer_commission_plan_assignment.assign', 'sales.referrer_commission_plan_assignment.change', 'sales.referrer_commission_plan_assignment.end', 'sales.referrer_commission_plan_assignment.cancel',
            ...
            'factory.shop_floor.view',
            'factory.shop_floor.work_queue.view',
            'factory.production_operation_execution.assign',
            'factory.production_operation_execution.accept',
            'factory.production_operation_execution.start',
            'factory.production_operation_execution.pause',
            'factory.production_operation_execution.resume',
            'factory.production_operation_execution.complete',
            'factory.production_operation_execution.submit',
            'factory.production_operation_execution.approve',
            'factory.production_operation_execution.post',
            'factory.production_operation_execution.reverse',
            'factory.production_operation_execution.sequence_override',
            'factory.production_operation_execution.quantity_override',
            'factory.production_time.correct',
            'factory.production_consumption.record',
            'factory.production_output.record',
            'factory.production_capacity.record',
            'factory.production_scrap.record',
            'factory.production_scrap.approve',
            'factory.production_rework.record',
            'factory.production_rework.approve',
            'factory.production_downtime.record',
            'factory.production_downtime.approve',
            'factory.production_quality.record',
            'factory.production_quality.release_hold',
            'factory.production_journal.submit',
            'factory.production_journal.approve',
            'factory.production_journal.post',
            ...
            'hr.performance_goal.approve', 'hr.performance_goal.revise',
            ...
            'hr.performance_improvement_plan.activate', 'hr.performance_improvement_plan.complete',
            'hr.performance_probation_review.decide',
            ...
            'hr.my_performance.view',
            'hr.my_goal.view', 'hr.my_goal.create', 'hr.my_goal.update',
            'hr.my_self_assessment.submit',
            'hr.my_appraisal.acknowledge', 'hr.my_appraisal.dispute',
            'hr.my_development_plan.view',
            'hr.my_performance_improvement_plan.view',
            ...
            'hr.recruitment_vacancy.open', 'hr.recruitment_vacancy.pause', 'hr.recruitment_vacancy.close',
            'hr.recruitment_candidate.archive', 'hr.recruitment_candidate.view_confidential',
            'hr.recruitment_application.advance', 'hr.recruitment_application.reject', 'hr.recruitment_application.reopen',
            'hr.recruitment_screening.override',
            'hr.recruitment_interview.score', 'hr.recruitment_interview.reopen_score',
            'hr.recruitment_selection_review.approve',
            'hr.recruitment_offer.approve', 'hr.recruitment_offer.issue', 'hr.recruitment_offer.withdraw',
            'hr.recruitment_pre_employment_check.view_confidential', 'hr.recruitment_pre_employment_check.waive',
            'hr.recruitment_hire.convert',
            'hr.recruitment_onboarding_task.complete', 'hr.recruitment_onboarding_task.approve', 'hr.recruitment_onboarding_task.waive',
            'hr.employee_confirmation_decision.approve', 'hr.employee_confirmation_decision.implement',
            'hr.recruitment_report.view', 'hr.recruitment_report.export',
            'hr.recruitment_history.view',
            'hr.team_recruitment.view', 'hr.team_recruitment.review',
            'hr.my_onboarding.view', 'hr.my_onboarding.update',
            'hr.my_probation_status.view', 'hr.my_confirmation_status.view',
            'candidate.application.view', 'candidate.application.create', 'candidate.application.update',
            'candidate.document.upload',
            'candidate.interview.view',
            'candidate.offer.view', 'candidate.offer.accept', 'candidate.offer.decline',
