            ...
            <form wire:submit="generateReport" class="space-y-4">
                ...
                <div class="flex justify-end gap-2">
                    <x-filament::button
                        ...
                        :href="route('reports.depreciation-book.print', array_merge($this->formData ?? [], ['business_id' => $this->businessId, 'format' => 'csv']))"
                    >
                        CSV
                    </x-filament::button>
                    <x-filament::button
                        ...
                        :href="route('reports.depreciation-book.print', array_merge($this->formData ?? [], ['business_id' => $this->businessId]))"
                        target="_blank"
                    >
                        Print
                    </x-filament::button>
