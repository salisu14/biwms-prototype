<x-filament::page>
    ...
    <div class="history-container">
        <header class="history-header">
            <h2>Purchasing History</h2>
            <p>Access historical Purchasing receipts, invoices, and archived orders.</p>
        </header>

        <div class="history-grid">
            {{-- Posted Receipts Card --}}
            <a href="{{ \App\Filament\Resources\PurchaseReceipts\PurchaseReceiptResource::getUrl('index') }}" class="history-card card-primary">
                <div class="card-header">
                    <div class="icon-box">
                        <x-heroicon-o-truck style="width: 1.5rem; height: 1.5rem;"/>
                    </div>
                    <div class="count-text">{{ $postedReceiptCount ?? 0 }}</div>
                </div>
                <div class="card-content">
                    <h3>Posted Receipts</h3>
                    <p>Track warehouse entries and item receipts.</p>
                </div>
            ...
            <a href="{{ \App\Filament\Resources\PurchaseInvoices\PurchaseInvoiceResource::getUrl('posted') }}" class="history-card card-success">
                ...
                <div class="card-content">
                    ...
                    <p>Finalized purchase bills and payment history.</p>
                </div>
                <div class="card-footer">
            ...
            {{-- Archived Purchase Orders Card --}}
            <a href="{{ \App\Filament\Resources\PurchaseOrders\PurchaseOrderResource::getUrl('archived') }}" class="history-card card-warning">
                <div class="card-header">
                    <div class="icon-box">
                ...
                <div class="card-content">
                    ...
                    <p>Closed orders for auditing and reference.</p>
                </div>
                <div class="card-footer">
