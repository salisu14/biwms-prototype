...
use App\Data\Purchase\{
    CreatePurchaseOrderData,
    UpdatePurchaseOrderData,
    ApprovePurchaseOrderData,
    CancelPurchaseOrderData,
    ClosePurchaseOrderData,
    RecalculatePurchaseOrderTotalsData,
    CreateReceiptData,
    PostInvoiceData
};
use App\Models\{NumberSeries, PurchaseOrder, PurchaseOrderLine, WarehouseReceipt, PostedPurchaseInvoice, Vendor};
...
class PurchaseOrderService
{
     ...
     */
    public function postInvoice(PostInvoiceData $data): PostedPurchaseInvoice
    {
        ...
        return DB::transaction(function () use ($order, $data) {
            ...
            foreach ($data->lines as $lineData) {
                ...
                if (!$poLine) throw new Exception("Purchase Order Line not found.");
