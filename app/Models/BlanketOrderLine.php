...
class BlanketOrderLine extends Model
{
    ...
    protected $table = 'blanket_order_lines';
    ...
    protected $casts = [
        ...
        'outstanding_qty_base' => 'decimal:4',
        ...
        'quantity_invoiced_base' => 'decimal:4',
    ...
    public function updateReceivedQuantity(float $quantity): void
    {
        ...
        $this->increment('quantity_received_base', $quantity * ($this->qty_per_unit_of_measure ?? 1));

        // Recalculate outstanding quantity base
        $this->outstanding_qty_base = $this->quantity_base - $this->quantity_received_base;
        $this->save();
    }
    ...
    public function updateInvoicedQuantity(float $quantity): void
    {
        ...
        $this->increment('quantity_invoiced_base', $quantity * ($this->qty_per_unit_of_measure ?? 1));
    }
    ...
    {
        return max(0, $this->quantity - $this->getOrderedQuantity());
    }
    ...
    {
        return $this->getOrderedQuantity() >= $this->quantity;
    }
}
