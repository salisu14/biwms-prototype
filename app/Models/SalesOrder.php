...
class SalesOrder extends Model implements Approvable
{
    ...
    protected $fillable = [
        ...
        'grand_total',
        'subtotal_lcy',
        'line_discount_total_lcy',
        'invoice_discount_amount_lcy',
        'total_amount_lcy',
        'total_vat_lcy',
        'grand_total_lcy',
        'currency_code',
    ...
    protected $casts = [
        ...
        'subtotal_lcy' => 'decimal:4',
        'line_discount_total_lcy' => 'decimal:4',
        'invoice_discount_amount_lcy' => 'decimal:4',
    ...
    */
    ...
    private function postGlEntriesForPostedInvoice(PostedSalesInvoice $postedInvoice): void
    {
        ...
        foreach ($postedInvoice->lines as $line) {
            ...
            if ($postedInvoice->order_id === null && $item->isInventoryItem() && (float) $line->cost_amount > 0) {
