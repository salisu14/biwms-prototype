        ...
        return $panel
            ...
            ->userMenuItems([
                Action::make('two_factor_auth')
                    ...
                    ->url(fn (): string => UserSecurity::getUrl(panel: 'admin')),
            ])
            ->renderHook(
...
//                            ->icon('heroicon-o-calculator')
                            ->items([
                                ...
                                NavigationItem::make('Fiscal Year Management')
                                    ...
                                    ->url(FiscalYearManagement::getUrl(panel: 'admin'))
                        ...
                        NavigationGroup::make('Finance')
                            ->items([
                                ...
                                NavigationItem::make('Expense Report')
                                    ->icon('heroicon-o-banknotes')
                                    ->url(ExpenseReport::getUrl(panel: 'admin'))
...
//                            ->icon('heroicon-o-shopping-cart')
                            ->items([
                                ...
                                NavigationItem::make('Purchases History')
                                    ...
                                    ->url(PurchaseHistory::getUrl(panel: 'admin'))
...
//                            ->icon('heroicon-o-cog-6-tooth')
                                ->items([
                                    ...
                                    NavigationItem::make('Leave Ledger')
                                        ->icon('heroicon-o-book-open')
                                        ->url(EmployeeLeaveLedgerEntryResource::getUrl(panel: 'admin'))
                            ...
                            NavigationGroup::make('Service Contracts')
                                ...
                                ->items([
                                    ...
                                    NavigationItem::make('Maintenance Contracts')
                                        ->icon('heroicon-o-document-text')
                                        ->url(MaintenanceContractResource::getUrl(panel: 'admin'))
                                    ...
                                    NavigationItem::make('Maintenance Contract Schedules')
                                        ->icon('heroicon-o-calendar-days')
                                        ->url(MaintenanceContractScheduleResource::getUrl(panel: 'admin'))
                                    ...
                                    NavigationItem::make('Maintenance Contract Billings')
                                        ->icon('heroicon-o-banknotes')
                                        ->url(MaintenanceContractBillingResource::getUrl(panel: 'admin'))
                                    ...
                                    NavigationItem::make('Maintenance Contract Assets')
                                        ->icon('heroicon-o-cube')
                                        ->url(MaintenanceContractAssetResource::getUrl(panel: 'admin'))
                            ...
                            NavigationGroup::make('Auth')
                                ...
                                ->items([
                                    ...
                                    NavigationItem::make('User Security')
                                        ...
                                        ->url(UserSecurity::getUrl(panel: 'admin'))
