...
use App\Policies\CommissionCalculationPolicy;
use App\Policies\CommissionDisputePolicy;
use App\Policies\CommissionHoldPolicy;
use App\Policies\CommissionLedgerEntryPolicy;
use App\Policies\CommissionLiabilityPostingPolicy;
use App\Policies\CommissionPaymentApplicationPolicy;
use App\Policies\CommissionPaymentBatchPolicy;
use App\Policies\CommissionPaymentLinePolicy;
use App\Policies\CommissionReviewBatchLinePolicy;
use App\Policies\CommissionReviewBatchPolicy;
use App\Policies\CommissionReviewPeriodPolicy;
use App\Policies\CommissionSettlementAllocationPolicy;
use App\Policies\CommissionSettlementBatchPolicy;
use App\Policies\CommissionSettlementLinePolicy;
...
use App\Policies\ProductionAlternateResourcePolicy;
use App\Policies\ProductionBomPolicy;
use App\Policies\ProductionBomVersionPolicy;
use App\Policies\ProductionCampaignOrderPolicy;
use App\Policies\ProductionCampaignPolicy;
use App\Policies\ProductionHierarchyNodePolicy;
use App\Policies\ProductionHierarchyPolicy;
use App\Policies\ProductionIntermediateHandoffPolicy;
use App\Policies\ProductionMaterialReservationPolicy;
use App\Policies\ProductionOperationDependencyPolicy;
use App\Policies\ProductionOperationExecutionPolicy;
use App\Policies\ProductionOperationSchedulePolicy;
use App\Policies\ProductionOrderPolicy;
use App\Policies\ProductionOrderSupplyLinkPolicy;
use App\Policies\ProductionSchedulePolicy;
use App\Policies\ProductionSchedulingExceptionPolicy;
...
use App\Policies\ReferralCommissionPlanCategoryPolicy;
use App\Policies\ReferralCommissionPlanItemPolicy;
use App\Policies\ReferralCommissionPlanPolicy;
use App\Policies\ReferralCommissionPlanTierPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(CustomerReferral::class, CustomerReferralPolicy::class);
        Gate::policy(Contact::class, ContactPolicy::class);
        Gate::policy(Referrer::class, ReferrerPolicy::class);
        Gate::policy(ReferralCommissionSetting::class, ReferralCommissionSettingPolicy::class);
        Gate::policy(ReferralCommissionPlan::class, ReferralCommissionPlanPolicy::class);
        Gate::policy(ReferralCommissionPlanTier::class, ReferralCommissionPlanTierPolicy::class);
        Gate::policy(ReferralCommissionPlanItem::class, ReferralCommissionPlanItemPolicy::class);
        Gate::policy(ReferralCommissionPlanCategory::class, ReferralCommissionPlanCategoryPolicy::class);
        Gate::policy(ReferrerCommissionPlanAssignment::class, ReferrerCommissionPlanAssignmentPolicy::class);
        Gate::policy(CommissionCalculation::class, CommissionCalculationPolicy::class);
        Gate::policy(CommissionLedgerEntry::class, CommissionLedgerEntryPolicy::class);
        Gate::policy(CommissionLiabilityPosting::class, CommissionLiabilityPostingPolicy::class);
        Gate::policy(CommissionPaymentBatch::class, CommissionPaymentBatchPolicy::class);
        Gate::policy(CommissionPaymentLine::class, CommissionPaymentLinePolicy::class);
        Gate::policy(CommissionPaymentApplication::class, CommissionPaymentApplicationPolicy::class);
        Gate::policy(CommissionReviewPeriod::class, CommissionReviewPeriodPolicy::class);
        Gate::policy(CommissionReviewBatch::class, CommissionReviewBatchPolicy::class);
        Gate::policy(CommissionReviewBatchLine::class, CommissionReviewBatchLinePolicy::class);
        Gate::policy(CommissionHold::class, CommissionHoldPolicy::class);
        Gate::policy(CommissionDispute::class, CommissionDisputePolicy::class);
        Gate::policy(CommissionSettlementBatch::class, CommissionSettlementBatchPolicy::class);
        Gate::policy(CommissionSettlementLine::class, CommissionSettlementLinePolicy::class);
        Gate::policy(CommissionSettlementAllocation::class, CommissionSettlementAllocationPolicy::class);
        Gate::policy(AuditTrail::class, AuditTrailPolicy::class);
        Gate::policy(Item::class, ItemPolicy::class);
        Gate::policy(OpeningInventory::class, OpeningInventoryPolicy::class);
        ...
        Gate::policy(ProductionHierarchy::class, ProductionHierarchyPolicy::class);
        Gate::policy(ProductionHierarchyNode::class, ProductionHierarchyNodePolicy::class);
        Gate::policy(ProductionOperationDependency::class, ProductionOperationDependencyPolicy::class);
        Gate::policy(ProductionIntermediateHandoff::class, ProductionIntermediateHandoffPolicy::class);
        Gate::policy(ProductionSchedule::class, ProductionSchedulePolicy::class);
        Gate::policy(ProductionOperationSchedule::class, ProductionOperationSchedulePolicy::class);
        Gate::policy(ProductionSchedulingException::class, ProductionSchedulingExceptionPolicy::class);
        Gate::policy(ProductionAlternateResource::class, ProductionAlternateResourcePolicy::class);
        Gate::policy(ProductionCampaign::class, ProductionCampaignPolicy::class);
        Gate::policy(ProductionCampaignOrder::class, ProductionCampaignOrderPolicy::class);
        Gate::policy(ProductionOrderSupplyLink::class, ProductionOrderSupplyLinkPolicy::class);
        Gate::policy(ProductionMaterialReservation::class, ProductionMaterialReservationPolicy::class);
        Gate::policy(ProductionOperationExecution::class, ProductionOperationExecutionPolicy::class);
