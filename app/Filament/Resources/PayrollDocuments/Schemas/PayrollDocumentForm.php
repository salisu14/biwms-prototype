                ...
                Group::make([
                    Section::make('Document Info')->schema([
                        ...
                        Select::make('status')
                            ...
                            ->default(\App\Enums\PayrollStatus::DRAFT->value)
                            ->required(),
                    ])->columns(2),
                ])->columnSpan(['lg' => 2]),
                        ...
                        Repeater::make('lines')
                            ...
                            ->schema([
                                Select::make('employee_id')
                                    ...
                                    ->getOptionLabelFromRecordUsing(fn (\App\Models\Employee $record) => "{$record->employee_number} - {$record->first_name} {$record->last_name}")
                                    ->required()
                                    ->columnSpan(2),
