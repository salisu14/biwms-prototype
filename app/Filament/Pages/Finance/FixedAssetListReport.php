...
class FixedAssetListReport extends Page implements HasForms
{
    ...
    protected static ?string $title = 'Fixed Asset List';

    protected string $view = 'filament.pages.finance.fixed-asset-list-report';
    ...
    {
        return app(FixedAssetListReportService::class)->generate($this->formData ?? []);
    }
    ...
    public function activeFilters(): array
    {
        ...
        if (filled($this->formData['status'] ?? null)) {
            $filters[] = ['label' => 'Status', 'value' => (string) $this->formData['status']];
        }
